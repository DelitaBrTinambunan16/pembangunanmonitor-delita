    ...
    <div class="container mt-5">
        ...
        <div class="mb-3 text-end">
            @if (in_array(auth()->user()->role, ['admin', 'staff']))
                <a href="{{ auth()->user()->role === 'admin' ? route('tahapan.create') : route('staff.tahapan.create') }}"
                ...
                <tbody>
                    @forelse($tahapan as $index => $t)
                        <tr>
                            ...
                            <td class="text-center">
                                @if ($t->media->count())
                                    <img src="{{ asset($t->media->first()->file_url) }}"  width="45" height="45"
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-1">
                                    ...
                                    @if (auth()->user()->role === 'admin')
                                        <a href="{{ route('tahapan.edit', $t->tahap_id) }}" class="btn btn-warning btn-sm">
